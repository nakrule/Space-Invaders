...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % 7 segments
    \draw[rounded corners, fill=green!50] (9,3) rectangle node{4x 7 segments} (11.5,4.5);
  \end{tikzpicture}
...
la mort du joueur.]{../Stable/v1.5/Display.vhd}
\end{wrapfigure}
...
savoir à quel pixel il correspond selon l’instant $t$ auquel il lit ces données
...
\lstinputlisting[style=vhdl]{../Stable/v1.5/alienRocket.vhd}
...
\clearpage
\subsection{Display}
\lstinputlisting[style=vhdl]{../Stable/v1.5/Display.vhd}
\clearpage
\subsection{Input}
\lstinputlisting[style=vhdl]{../Stable/v1.5/input.vhd}

\subsection{rocketManager}
\lstinputlisting[style=vhdl]{../Stable/v1.5/rocketManager.vhd}

\subsection{VGA Internal}
\lstinputlisting[style=vhdl]{../Stable/v1.5/VGA_Internal.vhd}
\clearpage
\subsection{Top Module}
\lstinputlisting[style=vhdl]{../Stable/v1.5/TopModule.vhd}

\subsection{Package}
\lstinputlisting[style=vhdl, lastline=93]{../Stable/v1.5/SpaceInvadersPackage.vhd}
